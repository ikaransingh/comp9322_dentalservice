...
definitions = {'definitions': {'booking': {'type': 'object', 'properties': {'patientName': {'type': 'string', 'example': 'Krishna'}, 'dentistName': {'type': 'string', 'example': 'Dr. Virdi'}, 'timeslot': {'type': 'string', 'example': '10'}}}}, 'parameters': {}}

validators = {
    ('booking', 'GET'): {'args': {'required': ['patientName', 'dentistName', 'timeslot'], 'properties': {'patientName': {'description': 'Enter patient name', 'type': 'string'}, 'dentistName': {'description': 'Enter dentist name', 'type': 'string'}, 'timeslot': {'description': 'Enter timeslot', 'type': 'string'}}}},
    ('booking', 'POST'): {'json': {'$ref': '#/definitions/booking'}},
}
...
filters = {
    ...
    ('booking', 'GET'): {200: {'headers': None, 'schema': {'type': 'object', 'properties': {'b_id': {'type': 'string', 'example': '1000'}}}}, 500: {'headers': None, 'schema': None}},
    ('booking', 'POST'): {201: {'headers': None, 'schema': None}, 500: {'headers': None, 'schema': None}},
