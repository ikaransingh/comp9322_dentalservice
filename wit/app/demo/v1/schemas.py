...
validators = {
    ('chat', 'GET'): {'args': {'required': ['expression', 'patientName'], 'properties': {'expression': {'description': 'user sentence e.g.  Who are available dentists?', 'type': 'string'}, 'patientName': {'description': 'Enter your name', 'type': 'string'}}}},
}

filters = {
    ('chat', 'GET'): {200: {'headers': None, 'schema': {'type': 'object', 'properties': {'answer': {'type': 'string'}, 'patientName': {'type': 'string'}}}}, 500: {'headers': None, 'schema': None}},
}
